...
quality_record::quality_record(const quality_record& from)
  ...
  ::memcpy(&queue_size_, &from.queue_size_,
    static_cast<size_t>(reinterpret_cast<char*>(&first_package_failed_) -
    reinterpret_cast<char*>(&queue_size_)) + sizeof(first_package_failed_));
...
void quality_record::SharedCtor() {
  ...
  ::memset(&queue_size_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&first_package_failed_) -
      reinterpret_cast<char*>(&queue_size_)) + sizeof(first_package_failed_));
}
