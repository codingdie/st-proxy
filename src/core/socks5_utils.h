...
static void proxy_connect(tcp::socket *proxy_sock, const std::string &socks_ip, std::uint32_t socks_port,
    ...
    auto *timer = new deadline_timer(proxy_sock->get_io_context());
